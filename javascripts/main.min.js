...
$(document).ready(function() {
    $("#steps-menu a").click(function(a) {
        a.preventDefault(), $(this).parent().addClass("is-active"), $(this).parent().siblings().removeClass("is-active");
        var b = $(this).attr("href");
        $(".step-content").not(b).css("display", "none"), $(b).fadeToggle(), $("#steps-menu").removeClass();
        var c = b.charAt(6);
        $("#steps-menu").addClass("step-" + c);
    ...
    "use strict";
    $(function() {
        $(".he-form__input").on("focus", function() {
            $(this).siblings(".he-form__label--floating").addClass("he-form__label--floated");
        }).on("blur", function() {
            var a = $(this);
            0 === a.val().length && a.siblings(".he-form__label--floating").removeClass("he-form__label--floated");
        });
    });
}(), function(a) {
    function b(b, c) {
    ...
    a.fn.jCarouselLite = function(b) {
        return b = a.extend({
            ...
            function e() {
                return o.slice(q).slice(0, n);
            }
            function f(c) {
                if (!g) {
                    if (b.beforeStart && b.beforeStart.call(this, e()), b.circular) c <= b.start - n - 1 ? (k.css(h, -((p - 2 * n) * r) + "px"), 
                    q = c == b.start - n - 1 ? p - 2 * n - 1 : p - 2 * n - b.scroll) : c >= p - n + 1 ? (k.css(h, -(n * r) + "px"), 
                    q = c == p - n + 1 ? n + 1 : n + b.scroll) : q = c; else {
                        if (0 > c || c > p - n) return;
                        q = c;
                    }
                    g = !0, k.animate("left" == h ? {
                        left: -(q * r)
                    } : {
                        top: -(q * r)
                    }, b.speed, b.easing, function() {
                        b.afterEnd && b.afterEnd.call(this, e()), g = !1;
                    }), b.circular || (a(b.btnPrev + "," + b.btnNext).removeClass("disabled"), a(q - b.scroll < 0 && b.btnPrev || q + b.scroll > p - n && b.btnNext || []).addClass("disabled"));
                }
                return !1;
            }
            var g = !1, h = b.vertical ? "top" : "left", i = b.vertical ? "height" : "width", j = a(this), k = a("ul", j), l = a("li", k), m = l.size(), n = b.visible;
            b.circular && (k.prepend(l.slice(m - n - 1 + 1).clone(!0)).append(l.slice(0, n).clone(!0)), 
            b.start += n);
            var o = a("li", k), p = o.size(), q = b.start;
            j.css("visibility", "visible"), o.css({
                overflow: "hidden",
            ...
            var r = b.vertical ? d(o) : c(o), s = r * p, t = r * n;
            o.css({
                width: o.width(),
                height: o.height()
            }), k.css(i, s + "px").css(h, -(q * r)), j.css(i, t + "px"), b.btnPrev && a(b.btnPrev).click(function() {
                return f(q - b.scroll);
            }), b.btnNext && a(b.btnNext).click(function() {
                return f(q + b.scroll);
            }), b.btnGo && a.each(b.btnGo, function(c, d) {
                a(d).click(function() {
                    return f(b.circular ? b.visible + c : c);
                });
            }), b.mouseWheel && j.mousewheel && j.mousewheel(function(a, c) {
                return f(c > 0 ? q - b.scroll : q + b.scroll);
    ...
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o = 0, p = {}, q = [], r = 0, s = {}, t = [], u = null, v = new Image(), w = /\.(jpg|gif|png|bmp|jpeg)(.*)?$/i, x = /[^\.]\.(swf)\s*$/i, y = 1, z = 0, A = "", B = !1, C = a.extend(a("<div/>")[0], {
        prop: 0
    }), D = a.browser.msie && a.browser.version < 7 && !window.XMLHttpRequest, E = function() {
        c.hide(), v.onerror = v.onload = null, u && u.abort(), b.empty();
    }, F = function() {
        return !1 === p.onError(q, o, p) ? (c.hide(), void (B = !1)) : (p.titleShow = !1, 
        p.width = "auto", p.height = "auto", b.html('<p id="fancybox-error">The requested content cannot be loaded.<br />Please try again later.</p>'), 
        void H());
    }, G = function() {
        var d, e, f, h, i, j, k = q[o];
        if (E(), p = a.extend({}, a.fn.fancybox.defaults, "undefined" == typeof a(k).data("fancybox") ? p : a(k).data("fancybox")), 
        j = p.onStart(q, o, p), j === !1) return void (B = !1);
        if ("object" == typeof j && (p = a.extend(p, j)), f = p.title || (k.nodeName ? a(k).attr("title") : k.title) || "", 
        k.nodeName && !p.orig && (p.orig = a(k).children("img:first").length ? a(k).children("img:first") : a(k)), 
        "" === f && p.orig && p.titleFromAlt && (f = p.orig.attr("alt")), d = p.href || (k.nodeName ? a(k).attr("href") : k.href) || null, 
        (/^(?:javascript)/i.test(d) || "#" == d) && (d = null), p.type ? (e = p.type, d || (d = p.content)) : p.content ? e = "html" : d && (e = d.match(w) ? "image" : d.match(x) ? "swf" : a(k).hasClass("iframe") ? "iframe" : 0 === d.indexOf("#") ? "inline" : "ajax"), 
        !e) return void F();
        switch ("inline" == e && (k = d.substr(d.indexOf("#")), e = a(k).length > 0 ? "inline" : "ajax"), 
        p.type = e, p.href = d, p.title = f, p.autoDimensions && ("html" == p.type || "inline" == p.type || "ajax" == p.type ? (p.width = "auto", 
        p.height = "auto") : p.autoDimensions = !1), p.modal && (p.overlayShow = !0, p.hideOnOverlayClick = !1, 
        p.hideOnContentClick = !1, p.enableEscapeButton = !1, p.showCloseButton = !1), p.padding = parseInt(p.padding, 10), 
        p.margin = parseInt(p.margin, 10), b.css("padding", p.padding + p.margin), a(".fancybox-inline-tmp").unbind("fancybox-cancel").bind("fancybox-change", function() {
          ...
          case "inline":
            if (a(k).parent().is("#fancybox-content") === !0) return void (B = !1);
          ...
          case "image":
            B = !1, a.fancybox.showActivity(), v = new Image(), v.onerror = function() {
                F();
            }, v.onload = function() {
          ...
          case "swf":
            p.scrolling = "no", h = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' + p.width + '" height="' + p.height + '"><param name="movie" value="' + d + '"></param>', 
            i = "", a.each(p.swf, function(a, b) {
          ...
          case "ajax":
            B = !1, a.fancybox.showActivity(), p.ajax.win = p.ajax.success, u = a.ajax(a.extend({}, p.ajax, {
                url: d,
                data: p.ajax.data || {},
                ...
                success: function(a, e, f) {
                    ...
                    if (200 == g.status) {
                        if ("function" == typeof p.ajax.win) {
                            if (j = p.ajax.win(d, a, e, f), j === !1) return void c.hide();
        ...
        var c = p.width, d = p.height;
        c = c.toString().indexOf("%") > -1 ? parseInt((a(window).width() - 2 * p.margin) * parseFloat(c) / 100, 10) + "px" : "auto" == c ? "auto" : c + "px", 
        d = d.toString().indexOf("%") > -1 ? parseInt((a(window).height() - 2 * p.margin) * parseFloat(d) / 100, 10) + "px" : "auto" == d ? "auto" : d + "px", 
        ...
        p.width = b.width(), p.height = b.height(), J();
    }, I = function() {
        p.width = v.width, p.height = v.height, a("<img />").attr({
            id: "fancybox-img",
            src: v.src,
            alt: p.title
        }).appendTo(b), J();
        ...
        var f, l;
        return c.hide(), e.is(":visible") && !1 === s.onCleanup(t, r, s) ? (a.event.trigger("fancybox-cancel"), 
        void (B = !1)) : (B = !0, a(g.add(d)).unbind(), a(window).unbind("resize.fb scroll.fb"), 
        a(document).unbind("keydown.fb"), e.is(":visible") && "outside" !== s.titlePosition && e.css("height", e.height()), 
        t = q, r = o, s = p, s.overlayShow ? (d.css({
        ...
        }), d.show())) : d.hide(), n = R(), L(), e.is(":visible") ? (a(h.add(j).add(k)).hide(), 
        f = e.position(), m = {
            top: f.top,
            left: f.left,
            width: e.width(),
            height: e.height()
        }, l = m.width == n.width && m.height == n.height, void g.fadeTo(s.changeFade, .3, function() {
            var c = function() {
        ...
        })) : (e.removeAttr("style"), g.css("border-width", s.padding), "elastic" == s.transitionIn ? (m = T(), 
        g.html(b.contents()), e.show(), s.opacity && (n.opacity = 0), C.prop = 0, void a(C).animate({
            prop: 1
        }, {
            duration: s.speedIn,
            easing: s.easingIn,
            ...
            width: n.width - 2 * s.padding,
            height: p.autoDimensions ? "auto" : n.height - z - 2 * s.padding
        }).html(b.contents()), void e.css(n).fadeIn("none" == s.transitionIn ? 0 : s.speedIn, N))));
    }, K = function(a) {
        return a && a.length ? "float" == s.titlePosition ? '<table id="fancybox-title-float-wrap" cellpadding="0" cellspacing="0"><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">' + a + '</td><td id="fancybox-title-float-right"></td></tr></table>' : '<div id="fancybox-title-' + s.titlePosition + '">' + a + "</div>" : !1;
    }, L = function() {
        if (A = s.title || "", z = 0, i.empty().removeAttr("style").removeClass(), s.titleShow === !1) return void i.hide();
        if (A = a.isFunction(s.titleFormat) ? s.titleFormat(A, t, r, s) : K(A), !A || "" === A) return void i.hide();
        switch (i.addClass("fancybox-title-" + s.titlePosition).html(A).appendTo("body").show(), 
        s.titlePosition) {
          case "inside":
            i.css({
                width: n.width - 2 * s.padding,
            ...
            }), z = i.outerHeight(!0), i.appendTo(f), n.height += z;
            break;
        ...
        return (s.enableEscapeButton || s.enableKeyboardNav) && a(document).bind("keydown.fb", function(b) {
            27 == b.keyCode && s.enableEscapeButton ? (b.preventDefault(), a.fancybox.close()) : 37 != b.keyCode && 39 != b.keyCode || !s.enableKeyboardNav || "INPUT" === b.target.tagName || "TEXTAREA" === b.target.tagName || "SELECT" === b.target.tagName || (b.preventDefault(), 
            a.fancybox[37 == b.keyCode ? "prev" : "next"]());
        }), s.showNavArrows ? ((s.cyclic && t.length > 1 || 0 !== r) && j.show(), void ((s.cyclic && t.length > 1 || r != t.length - 1) && k.show())) : (j.hide(), 
        void k.hide());
    }, N = function() {
        a.support.opacity || (g.get(0).style.removeAttribute("filter"), e.get(0).style.removeAttribute("filter")), 
        p.autoDimensions && g.css("height", "auto"), e.css("height", "auto"), A && A.length && i.show(), 
        s.showCloseButton && h.show(), M(), s.hideOnContentClick && g.bind("click", a.fancybox.close), 
        s.hideOnOverlayClick && d.bind("click", a.fancybox.close), a(window).bind("resize.fb", a.fancybox.resize), 
        s.centerOnScroll && a(window).bind("scroll.fb", a.fancybox.center), "iframe" == s.type && a('<iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0" hspace="0" ' + (a.browser.msie ? 'allowtransparency="true""' : "") + ' scrolling="' + p.scrolling + '" src="' + s.href + '"></iframe>').appendTo(g), 
        e.show(), B = !1, a.fancybox.center(), s.onComplete(t, r, s), O();
    }, O = function() {
        var a, b;
        t.length - 1 > r && (a = t[r + 1].href, "undefined" != typeof a && a.match(w) && (b = new Image(), 
        b.src = a)), r > 0 && (a = t[r - 1].href, "undefined" != typeof a && a.match(w) && (b = new Image(), 
        b.src = a));
    }, P = function(a) {
        var b = {
        ...
        "undefined" != typeof n.opacity && (b.opacity = .5 > a ? .5 : a), e.css(b), g.css({
        ...
        var a, b = Q(), c = {}, d = s.autoScale, e = 2 * s.padding;
        return s.width.toString().indexOf("%") > -1 ? c.width = parseInt(b[0] * parseFloat(s.width) / 100, 10) : c.width = s.width + e, 
        s.height.toString().indexOf("%") > -1 ? c.height = parseInt(b[1] * parseFloat(s.height) / 100, 10) : c.height = s.height + e, 
        d && (c.width > b[0] || c.height > b[1]) && ("image" == p.type || "swf" == p.type ? (a = s.width / s.height, 
        c.width > b[0] && (c.width = b[0], c.height = parseInt((c.width - e) / a + e, 10)), 
        c.height > b[1] && (c.height = b[1], c.width = parseInt((c.height - e) * a + e, 10))) : (c.width = Math.min(c.width, b[0]), 
        c.height = Math.min(c.height, b[1]))), c.top = parseInt(Math.max(b[3] - 20, b[3] + .5 * (b[1] - c.height - 40)), 10), 
        c.left = parseInt(Math.max(b[2] - 20, b[2] + .5 * (b[0] - c.width - 40)), 10), c;
    }, S = function(a) {
        var b = a.offset();
        return b.top += parseInt(a.css("paddingTop"), 10) || 0, b.left += parseInt(a.css("paddingLeft"), 10) || 0, 
        b.top += parseInt(a.css("border-top-width"), 10) || 0, b.left += parseInt(a.css("border-left-width"), 10) || 0, 
        b.width = a.width(), b.height = a.height(), b;
    }, T = function() {
        var b, c, d = p.orig ? a(p.orig) : !1, e = {};
        return d && d.length ? (b = S(d), e = {
            width: b.width + 2 * s.padding,
        ...
        return c.is(":visible") ? (a("div", c).css("top", -40 * y + "px"), void (y = (y + 1) % 12)) : void clearInterval(l);
    };
    a.fn.fancybox = function(b) {
        return a(this).length ? (a(this).data("fancybox", a.extend({}, b, a.metadata ? a(this).metadata() : {})).unbind("click.fb").bind("click.fb", function(b) {
            if (b.preventDefault(), !B) {
                ...
                c && "" != c && "nofollow" !== c ? (q = a("a[rel=" + c + "], area[rel=" + c + "]"), 
                o = q.index(this)) : q.push(this), G();
            }
        }), this) : this;
    }, a.fancybox = function(b) {
        var c;
        if (!B) {
            if (B = !0, c = "undefined" != typeof arguments[1] ? arguments[1] : {}, q = [], 
            o = parseInt(c.index, 10) || 0, a.isArray(b)) {
        ...
        B || (a = parseInt(a), q = t, a > -1 && a < t.length ? (o = a, G()) : s.cyclic && t.length > 1 && (o = a >= t.length ? 0 : t.length - 1, 
        G()));
    }, a.fancybox.cancel = function() {
        B || (B = !0, a.event.trigger("fancybox-cancel"), E(), p.onCancel(q, o, p), B = !1);
    }, a.fancybox.close = function() {
        function b() {
            d.fadeOut("fast"), i.empty().hide(), e.hide(), a.event.trigger("fancybox-cleanup"), 
            g.empty(), s.onClosed(t, r, s), t = p = [], r = o = 0, s = p = {}, B = !1;
        }
        if (!B && !e.is(":hidden")) {
            if (B = !0, s && !1 === s.onCleanup(t, r, s)) return void (B = !1);
            if (E(), a(h.add(j).add(k)).hide(), a(g.add(d)).unbind(), a(window).unbind("resize.fb scroll.fb"), 
            a(document).unbind("keydown.fb"), g.find("iframe").attr("src", D && /^https/i.test(window.location.href || "") ? "javascript:void(false)" : "about:blank"), 
            "inside" !== s.titlePosition && i.empty(), e.stop(), "elastic" == s.transitionOut) {
                m = T();
                var c = e.position();
                n = {
                    top: c.top,
                    ...
                    width: e.width(),
                    height: e.height()
                }, s.opacity && (n.opacity = 1), i.empty().hide(), C.prop = 1, a(C).animate({
                    prop: 0
                }, {
                    duration: s.speedOut,
                    easing: s.easingOut,
        ...
        var a, b;
        B || (b = arguments[0] === !0 ? 1 : 0, a = Q(), !b && (e.width() > a[0] || e.height() > a[1]) || e.stop().animate({
            top: parseInt(Math.max(a[3] - 20, a[3] + .5 * (a[1] - g.height() - 40) - s.padding)),
            left: parseInt(Math.max(a[2] - 20, a[2] + .5 * (a[0] - g.width() - 40) - s.padding))
        }, "number" == typeof arguments[0] ? arguments[0] : 200));
    }, a.fancybox.init = function() {
        a("#fancybox-wrap").length || (a("body").append(b = a('<div id="fancybox-tmp"></div>'), c = a('<div id="fancybox-loading"><div></div></div>'), d = a('<div id="fancybox-overlay"></div>'), e = a('<div id="fancybox-wrap"></div>')), 
        ...
        h.click(a.fancybox.close), c.click(a.fancybox.cancel), j.click(function(b) {
            b.preventDefault(), a.fancybox.prev();
        }), k.click(function(b) {
            b.preventDefault(), a.fancybox.next();
        }), a.fn.mousewheel && e.bind("mousewheel.fb", function(b, c) {
            B ? b.preventDefault() : 0 != a(b.target).get(0).clientHeight && a(b.target).get(0).scrollHeight !== a(b.target).get(0).clientHeight || (b.preventDefault(), 
            a.fancybox[c > 0 ? "prev" : "next"]());
        }), a.support.opacity || e.addClass("fancybox-ie"), D && (c.addClass("fancybox-ie6"), 
        e.addClass("fancybox-ie6"), a('<iframe id="fancybox-hide-sel-frame" src="' + (/^https/i.test(window.location.href || "") ? "javascript:void(false)" : "about:blank") + '" scrolling="no" border="0" frameborder="0" tabindex="-1"></iframe>').prependTo(f)));
    ...
    $(function() {
        $(".dropdown__button").click(function() {
            var a, b;
            a = $(this), b = a.siblings(".dropdown__menu"), b.toggleClass("dropdown__menu--show"), 
            a.toggleClass("dropdown__button--opened"), b.children(".dropdown__menu-item").click(function() {
                $("#budget").val($(this).data("value")), a.removeClass("dropdown__button--opened"), 
                b.removeClass("dropdown__menu--show"), a.html($(this).html());
            });
        });
    });
}(), function() {
    ...
    $(function() {
        $(".modal__state").on("change", function() {
            ...
            $(".modal__state").prop("checked", !1).change();
        }), $(".modal__inner").on("click", function(a) {
            a.stopPropagation();
        });
    });
}(), jQuery(document).ready(function(a) {
    function b() {
        e || (e = !0, window.requestAnimationFrame ? window.requestAnimationFrame(c) : setTimeout(c, 300));
    }
    function c() {
        var b = a(window).height() / 2, c = a(window).scrollTop();
        f.each(function() {
            var d = a(this), e = d.attr("id"), f = h.filter('[href^="#' + e + '"]');
            d.offset().top - b < c && d.offset().top + d.height() - b > c ? f.parent().addClass("sida-bar-active") : f.parent().removeClass("sida-bar-active");
        }), e = !1;
    }
    function d(b) {
        a("body,html").animate({
    ...
    var e = !1, f = a("section"), g = a(".nav-fixed"), h = g.find("a"), i = a(".cd-nav-trigger"), j = a(".cd-scroll-down");
    a(window).on("scroll", b), g.on("click", "a", function(b) {
        b.preventDefault(), d(a(this.hash));
    }), j.on("click", function(b) {
        b.preventDefault(), d(a(this.hash));
    }), i.on("click", function(a) {
        a.preventDefault(), g.toggleClass("open");
    }), a(".main-banner__arrow-down").click(function(b) {
        b.preventDefault(), d(a("#services"));
    }), a("a.scroll").click(function(a) {});
}), $(window).scroll(function() {
    $(window).scrollTop() > 100 ? $(".main-header").addClass("main-header--fixed") : $(".main-header").removeClass("main-header--fixed");
});
...
function(a) {
    "use strict";
    function b() {
        a(".main-banner__title").waypoint(function() {
            a(".main-banner__title").addClass("animated fadeIn");
        }, {
            offset: "75%"
        }), a(".main-banner__subtitle").waypoint(function() {
            a(".main-banner__subtitle").addClass("animated fadeInUp");
        }, {
            offset: "75%"
        }), a(".section-offer__heading").waypoint(function() {
            a(".section-offer__heading").addClass("animated fadeIn");
        }, {
            offset: "75%"
        }), a(".section-offer__box").waypoint(function() {
            a(".section-offer__box").addClass("animated fadeInUp");
        }, {
            offset: "75%"
        }), a(".ourwork__title, .our-services__title, .hire-us__title, .about-us__title").waypoint(function() {
            a(".ourwork__title, .our-services__title, .hire-us__title, .about-us__title").addClass("animated fadeInUp");
        }, {
            offset: "75%"
        }), a(".ourwork__subtitle, .our-services__subtitle, .hire-us__subtitle, .about-us__subtitle").waypoint(function() {
            a(".ourwork__subtitle, .our-services__subtitle, .hire-us__subtitle, .about-us__subtitle").addClass("animated fadeInUp");
        }, {
            offset: "100%"
        });
    }
    function c() {
        var b = function() {
            var b = a(this).find("img"), c = b.data("video");
            b.data("video", b.attr("src")), b.attr("src", c);
        };
        a(function() {
            a(".rollover").hover(b, b);
        });
    }
    function d() {
        function b() {}
    ...
    function e() {
        a(".bxblog, .bxtwitter").bxSlider({
            mode: "fade"
        }), a(".bxprojects").bxSlider({
            slideMargin: 60
        });
    }
    function f() {
        a(".js-toggle-menu").on("click", function(b) {
            b.preventDefault(), a(this).toggleClass("toggle--close"), a(".navbar-nav").toggleClass("navbar-nav--is-open"), 
            a("body").toggleClass("main-content-toleft"), a(".main-header").toggleClass("main-content-toleft");
        });
    }
    function g() {
        var b = location.pathname;
        a(".navbar-nav a").each(function(c) {
            return 0 == b.indexOf(a(this).attr("href")) ? (a(this).addClass("current-page").parent().addClass("current-li"), 
            !1) : void 0;
        });
    }
    function h() {
        a(".bxslider").bxSlider({
            ...
            nextText: "EN" == language ? "Next" : "Próximo",
            prevText: "EN" == language ? "Previous" : "Anterior",
            adaptiveHeight: !0,
            responsive: !0
    ...
    function i() {
        var b = {
            $el: a("#carousel-slider .slideshow"),
            clickImage: function(b) {
                var c = a(b.target), d = c.index(), e = c.parent().find(".cycle-slide-active").index();
                return this.cycle(d == e ? "prev" : "next"), !1;
            },
            ...
            init: function() {
                ...
                }), this.$el.on("click", "img", a.proxy(this.clickImage, this.$el)).find("img").css("opacity", "");
            }
        };
        b.init();
    }
    ...
    function k() {
        isMobile ? a(".player").addClass("main-banner__bg--mobile") : (a(".player").YTPlayer(), 
        a(".player").removeClass("main-banner__bg--mobile"));
    }
    function l() {
        f(), b(), e(), d(), c(), g(), h(), i(), j(), k();
    }
...
!function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            return this.each(function() {
                ...
                YTPlayer.id = YTPlayer.id || "YTP_" + new Date().getTime(), YTPlayer.filters = {
                    grayscale: {
                        value: 0,
                        unit: "%"
                    },
                ...
                jQuery.extend(YTPlayer.defaultOpt, jQuery.mbYTPlayer.defaults, options)), "true" == YTPlayer.opt.loop && (YTPlayer.opt.loop = 9999), 
                        ...
                        jQuery(YTPlayer).on("YTPChanged", function() {
                            if (!YTPlayer.isInit) {
                                ...
                                new YT.Player(playerID, {
                                    ...
                                    events: {
                                        onReady: function(a) {
                                            YTPlayer.player = a.target, YTPlayer.isReady || (YTPlayer.isReady = !YTPlayer.isPlayer || YTPlayer.opt.autoPlay, 
                                            YTPlayer.playerEl = YTPlayer.player.getIframe(), jQuery(YTPlayer.playerEl).unselectable(), 
                                            $YTPlayer.optimizeDisplay(), YTPlayer.videoID = videoID, jQuery(window).off("resize.YTP_" + YTPlayer.id).on("resize.YTP_" + YTPlayer.id, function() {
                                            ...
                                            if ("function" == typeof event.target.getPlayerState) {
                                                ...
                                                if (YTPlayer.state != state) {
                                                    ...
                                                    switch (state) {
                                                      ...
                                                      case 1:
                                                        eventType = "YTPPlay", YTPlayer.controlBar && YTPlayer.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.pause), 
        ...
        playlist: function(a, b, c) {
            ...
            jQuery(e).mb_YTPlayer()), "function" == typeof c && jQuery(e).one("YTPChanged", function() {
                c(e);
        ...
        changeMovie: function(a) {
            ...
            b.player.loopTime = void 0, a && jQuery.extend(b.opt, b.defaultOpt, a), b.videoID = getYTPVideoID(b.opt.videoURL).videoID, 
            "true" == b.opt.loop && (b.opt.loop = 9999), jQuery(b.playerEl).CSSAnimate({
                opacity: 0
            }, 200, function() {
                var a = jQuery.Event("YTPChangeMovie");
                return a.time = b.player.time, a.videoId = b.videoID, jQuery(b).trigger(a), jQuery(b).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + b.videoID), 1, b.opt.quality), 
                jQuery(b).optimizeDisplay(), jQuery.mbYTPlayer.checkForState(b), jQuery.mbYTPlayer.getDataFromAPI(b), 
                this;
            });
        },
        getPlayer: function() {
        ...
        fullscreen: function(real) {
            ...
            if (real) {
                ...
                jQuery(document).off(fullscreenchange).on(fullscreenchange, function() {
                    ...
                    videoWrapper.removeClass("YTPFullscreen"), videoWrapper.CSSAnimate({
        ...
        checkForState: function(YTPlayer) {
            ...
            void (YTPlayer.getState = setInterval(function() {
                ...
                1 == YTPlayer.player.getPlayerState() && (parseFloat(YTPlayer.player.getDuration() - 1.5) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                    ...
                    YTPlayer.preventTrigger = !0, jQuery(YTPlayer).YTPPause(), YTPlayer.state = 0, void YTPlayer.wrapper.CSSAnimate({
                        opacity: 0
                    }, 500, function() {
                        YTPlayer.controlBar && YTPlayer.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
                    ...
                    startAt = startAt || 1, YTPlayer.preventTrigger = !0, jQuery(YTPlayer).YTPPause(), 
                    YTPlayer.player.seekTo(startAt, !0), $YTPlayer.YTPPlay();
                }
        ...
        checkForStart: function(a) {
            ...
            if (a.preventTrigger = !0, jQuery(a).YTPPause(), jQuery(a).muteYTPVolume(), jQuery("#controlBar_" + a.id).remove(), 
            a.opt.showControls && jQuery.mbYTPlayer.buildControls(a), a.opt.addRaster) {
            ...
            a.player.playVideo(), a.player.seekTo(d, !0), a.checkForStartAt = setInterval(function() {
                ...
                if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
                    ...
                    if (e.time = a.player.time, jQuery(a).trigger(e), a.preventTrigger = !0, jQuery(a).YTPPause(), 
                    a.opt.mute || jQuery(a).YTPUnmute(), a.canTrigger = !0, a.opt.autoPlay) {
                        b.YTPPlay();
                        var f = jQuery.Event("YTPStart");
                        f.time = a.player.time, jQuery(a).trigger(f), b.css("background-image", "none"), 
        ...
        if (b.optimizeDisplay) {
            ...
            d.marginTop = -((d.height - g.height) / 2), d.marginLeft = -(g.width * (e / 2) / 100), 
            d.height < g.height && (d.height = g.height + g.height * e / 100, d.width = "16/9" == b.ratio ? Math.floor(16 * g.height / 9) : Math.floor(4 * g.height / 3), 
            d.marginTop = -(g.height * (e / 2) / 100), d.marginLeft = -((d.width - g.width) / 2)), 
            d.width += f, d.height += f, d.marginTop -= f / 2, d.marginLeft -= f / 2;
    ...
    jQuery.fn.YTPEnableFilters = jQuery.mbYTPlayer.enableFilters, jQuery.fn.YTPAddMask = jQuery.mbYTPlayer.addMask, 
    jQuery.fn.YTPRemoveMask = jQuery.mbYTPlayer.removeMask, jQuery.fn.mb_YTPlayer = jQuery.mbYTPlayer.buildPlayer, 
        ...
        return this.each(function() {
            ...
            if (g.CSSqueue = null, g.eventType = i.type, 0 !== h.length && a) {
                ...
                setTimeout(function() {
                    ...
                    return g.called || !e ? (g.called = !1, void (g.CSSAIsRunning = !1)) : (h.css(jQuery.CSS.sfx + "transition", ""), 
...
jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt), !function(a) {
