...
!function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
                                ...
                                new YT.Player(playerID, {
                                    ...
                                    events: {
                                        onReady: function(a) {
                                            ...
                                            $YTPlayer.optimizeDisplay(), YTPlayer.videoID = videoID, jQuery(window).off("resize.YTP").on("resize.YTP", function() {
        ...
        play: function() {
            var a = this.get(0);
            return a.isReady ? (a.player.playVideo(), a.wrapper.CSSAnimate({
                opacity: a.isAlone ? 1 : a.opt.opacity
            }, 2e3), jQuery(a.playerEl).CSSAnimate({
                opacity: 1
            }, 1e3), jQuery(a).css("background-image", "none"), this) : void 0;
        },
        ...
        checkForState: function(YTPlayer) {
            ...
            void (YTPlayer.getState = setInterval(function() {
                ...
                1 == YTPlayer.player.getPlayerState() && (parseFloat(YTPlayer.player.getDuration() - 1.5) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                    ...
                    YTPlayer.preventTrigger = !0, jQuery(YTPlayer).YTPPause(), void YTPlayer.wrapper.CSSAnimate({
                        opacity: 0
                    }, 1e3, function() {
        ...
        var a = this.get(0);
        return a ? a.player.isMuted() ? (jQuery(a).YTPUnmute(), !0) : (jQuery(a).YTPMute(), 
        !1) : void 0;
