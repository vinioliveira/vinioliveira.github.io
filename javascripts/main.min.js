function getHashFilter() {
    var a = location.hash.match(/filter=([^&]+)/i), b = a && a[1];
...
$(function() {
    function a() {
        var a = getHashFilter();
        !a && d || (d = !0, b.imagesLoaded(function() {
            b.isotope({
                itemSelector: ".element-item",
                layoutMode: "packery",
                filter: filterFns[a] || a
            });
        }), a && (c.find(".is-checked").removeClass("is-checked"), c.find('[data-filter="' + a + '"]').addClass("is-checked")));
    }
    var b = $(".grid"), c = $("#grid-filter");
    c.on("click", "a", function() {
        var a = $(this).attr("data-filter");
        location.hash = "filter=" + encodeURIComponent(a);
    });
    var d = !0;
    $(window).on("hashchange", a), a();
}), function(a) {
    function b(b, c) {
