var instantClick, InstantClick = instantClick = function(a, b, c) {
    function d(a) {
        var b = a.indexOf("#");
    ...
    function f(a) {
        do {
            ...
            if (a.hasAttribute("data-instant")) return !1;
            if (a.hasAttribute("data-no-instant")) return !0;
        } while (a = a.parentNode);
        return !1;
    }
    function g(a) {
        var c = b.protocol + "//" + b.host;
        return !(a.target || a.hasAttribute("download") || 0 != a.href.indexOf(c + "/") || a.href.indexOf("#") > -1 && d(a.href) == x || f(a));
    }
    function h(a, b, c, d) {
        for (var e = !1, f = 0; f < O[a].length; f++) if ("receive" == a) {
            var g = O[a][f](b, c, d);
            g && ("body" in g && (c = g.body), "title" in g && (d = g.title), e = g);
        } else O[a][f](b, c, d);
        return e;
    }
    function i(b, c, e, f, g) {
        if (a.documentElement.replaceChild(c, a.body), e) {
            history.pushState(null, null, e);
            var i = e.indexOf("#"), j = i > -1 && a.getElementById(e.substr(i + 1)), k = 0;
            if (j) for (;j.offsetParent; ) k += j.offsetTop, j = j.offsetParent;
            scrollTo(0, k), x = d(e);
        } else scrollTo(0, f);
        E && a.title == b ? a.title = b + String.fromCharCode(160) : a.title = b, s(), g ? h("restore") : h("change", !1);
    }
    function j() {
        L = !1, M = !1;
    }
    function k(a) {
        return a.replace(/<noscript[\s\S]+?<\/noscript>/gi, "");
    }
    function l(a) {
        if (!(A > +new Date() - 500)) {
            var b = e(a.target);
    ...
    function m(a) {
        if (!(A > +new Date() - 500)) {
            var b = e(a.target);
            b && g(b) && (b.addEventListener("mouseout", p), D ? (y = b.href, z = setTimeout(t, D)) : t(b.href));
        }
    }
    function n(a) {
        A = +new Date();
        var b = e(a.target);
        b && g(b) && (C ? b.removeEventListener("mousedown", l) : b.removeEventListener("mouseover", m), 
        t(b.href));
    }
    function o(a) {
        var b = e(a.target);
        b && g(b) && (a.which > 1 || a.metaKey || a.ctrlKey || (a.preventDefault(), u(b.href)));
    }
    function p() {
        return z ? (clearTimeout(z), void (z = !1)) : void (L && !M && (B.abort(), j()));
    }
    function q() {
        if (!(B.readyState < 4) && 0 != B.status) {
            if (K.ready = +new Date() - K.start, B.getResponseHeader("Content-Type").match(/\/(x|ht|xht)ml/)) {
                var b = a.implementation.createHTMLDocument("");
                b.documentElement.innerHTML = k(B.responseText), H = b.title, J = b.body;
                var c = h("receive", G, J, H);
                c && ("body" in c && (J = c.body), "title" in c && (H = c.title));
                var e = d(G);
                F[e] = {
                    body: J,
                    title: H,
                    scrollY: e in F ? F[e].scrollY : 0
                };
                for (var f, g, i = b.head.children, j = 0, l = 0; l < i.length; l++) if (f = i[l], 
                f.hasAttribute("data-instant-track")) {
                    g = f.getAttribute("href") || f.getAttribute("src") || f.innerHTML;
                    for (var m = 0; m < N.length; m++) N[m] == g && j++;
                }
                j != N.length && (I = !0);
            } else I = !0;
            M && (M = !1, u(G));
    ...
    function r() {
        var a = d(b.href);
        if (a != x) {
            if (!(a in F)) return void (b.href = b.href);
            F[x].scrollY = pageYOffset, x = a, i(F[a].title, F[a].body, !1, F[a].scrollY, !0);
        }
    }
    function s(b) {
        if (a.body.addEventListener("touchstart", n, !0), C ? a.body.addEventListener("mousedown", l, !0) : a.body.addEventListener("mouseover", m, !0), 
        a.body.addEventListener("click", o, !0), !b) for (var c, d, e, f, g = a.body.getElementsByTagName("script"), h = 0, i = g.length; i > h; h++) c = g[h], 
        c.hasAttribute("data-no-instant") || (d = a.createElement("script"), c.src && (d.src = c.src), 
        c.innerHTML && (d.innerHTML = c.innerHTML), e = c.parentNode, f = c.nextSibling, 
        e.removeChild(c), e.insertBefore(d, f));
    }
    function t(a) {
        !C && "display" in K && +new Date() - (K.start + K.display) < 100 || (z && (clearTimeout(z), 
        z = !1), a || (a = y), L && (a == G || M) || (L = !0, M = !1, G = a, J = !1, I = !1, 
        K = {
            start: +new Date()
        }, h("fetch"), B.open("GET", a), B.send()));
    }
    function u(a) {
        return "display" in K || (K.display = +new Date() - K.start), z || !L ? z && G && G != a ? void (b.href = a) : (t(a), 
        h("wait"), void (M = !0)) : M ? void (b.href = a) : I ? void (b.href = G) : J ? (F[x].scrollY = pageYOffset, 
        j(), void i(H, J, G)) : (h("wait"), void (M = !0));
    }
    function v(c) {
        if (!x) {
            if (!P) return void h("change", !0);
            "mousedown" == c ? C = !0 : "number" == typeof c && (D = c), x = d(b.href), F[x] = {
                body: a.body,
                title: a.title,
                scrollY: pageYOffset
            };
            for (var e, f, g = a.head.children, i = 0; i < g.length; i++) e = g[i], e.hasAttribute("data-instant-track") && (f = e.getAttribute("href") || e.getAttribute("src") || e.innerHTML, 
            N.push(f));
            B = new XMLHttpRequest(), B.addEventListener("readystatechange", q), s(!0), h("change", !0), 
    ...
    var x, y, z, A, B, C, D, E = c.indexOf(" CriOS/") > -1, F = {}, G = !1, H = !1, I = !1, J = !1, K = {}, L = !1, M = !1, N = [], O = {
        fetch: [],
        receive: [],
        wait: [],
        change: [],
        restore: []
    }, P = "pushState" in history && (!c.match("Android") || c.match("Chrome/")) && "file:" != b.protocol;
    return {
        supported: P,
        init: v,
        on: w
...
!function(a) {
    ...
    a.fn.counterUp = function(b) {
        ...
        return this.each(function() {
            var b = a(this), d = c, e = function() {
                b.data("counterupTo") || b.data("counterupTo", b.text());
                var a = d.time / d.delay, c = b.data("counterupTo"), e = [ c ], f = /[0-9]+,[0-9]+/.test(c);
                c = c.replace(/,/g, "");
                for (var g = (/^[0-9]+$/.test(c), /^[0-9]+\.[0-9]+$/.test(c)), h = g ? (c.split(".")[1] || []).length : 0, i = a; i >= 1; i--) {
                    var j = parseInt(c / a * i);
                    if (g && (j = parseFloat(c / a * i).toFixed(h)), f) for (;/(\d+)(\d{3})/.test(j.toString()); ) j = j.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                    e.unshift(j);
                }
                b.data("counterup-nums", e), b.text("0");
                var k = function() {
                    b.text(b.data("counterup-nums").shift()), b.data("counterup-nums").length ? setTimeout(b.data("counterup-func"), d.delay) : (delete b.data("counterup-nums"), 
                    b.data("counterup-nums", null), b.data("counterup-func", null));
                };
    ...
    a(document).on("cycle-bootstrap", function(a, b, c) {
        ...
        prepareDimensions: function(b) {
            ...
            if (b.carouselFluid && b.carouselVisible ? b._carouselResizeThrottle || this.fluidSlides(b) : b.carouselVisible && b.carouselSlideDimension ? (c = g * b.carouselSlideDimension, 
            b.container[f ? "height" : "width"](c)) : b.carouselVisible && (c = g * a(b.slides[0])[f ? "outerHeight" : "outerWidth"](!0), 
            b.container[f ? "height" : "width"](c)), d = b.carouselOffset || 0, b.allowWrap !== !1) if (b.carouselSlideDimension) d -= (b.slideCount + b.currSlide) * b.carouselSlideDimension; else {
        ...
        onDestroy: function(b) {
            var c = this.opts();
            c._carouselResizeThrottle && a(window).off("resize", c._carouselResizeThrottle), 
            c.slides.prependTo(c.container), c._carouselWrap.remove();
        }
    };
}(jQuery), function(a) {
    "use strict";
    ...
    function a(d) {
        ...
        this.key = "waypoint-" + b, this.options = a.Adapter.extend({}, a.defaults, d), 
        this.element = this.options.element, this.adapter = new a.Adapter(this.element), 
        this.callback = d.handler, this.axis = this.options.horizontal ? "horizontal" : "vertical", 
        this.enabled = this.options.enabled, this.triggerPoint = null, this.group = a.Group.findOrCreate({
            name: this.options.group,
            axis: this.axis
        }), this.context = a.Context.findOrCreateByElement(this.options.context), a.offsetAliases[this.options.offset] && (this.options.offset = a.offsetAliases[this.options.offset]), 
        this.group.add(this), this.context.add(this), c[this.key] = this, b += 1;
    }
    var b = 0, c = {};
    ...
    function b(a) {
        this.element = a, this.Adapter = e.Adapter, this.adapter = new this.Adapter(a), 
        this.key = "waypoint-context-" + c, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            x: this.adapter.scrollLeft(),
            y: this.adapter.scrollTop()
        }, this.waypoints = {
            vertical: {},
            horizontal: {}
        }, a.waypointContextKey = this.key, d[a.waypointContextKey] = this, c += 1, this.createThrottledScrollHandler(), 
    ...
    b.prototype.add = function(a) {
        ...
        for (var f in a) {
            ...
            for (var h in this.waypoints[f]) {
                ...
                n.element !== n.element.window && (q = n.adapter.offset()[g.offsetProp]), "function" == typeof o ? o = o.apply(n) : "string" == typeof o && (o = parseFloat(o), 
                n.options.offset.indexOf("%") > -1 && (o = Math.ceil(g.contextDimension * o / 100))), 
                i = g.contextScroll - g.contextOffset, n.triggerPoint = q + i - o, j = p < g.oldScroll, 
                k = n.triggerPoint >= g.oldScroll, l = j && k, m = !j && !k, !r && l ? (n.queueTrigger(g.backward), 
                d[n.group.id] = n.group) : !r && m ? (n.queueTrigger(g.forward), d[n.group.id] = n.group) : r && g.oldScroll >= n.triggerPoint && (n.queueTrigger(g.forward), 
    ...
    function c(a) {
        this.name = a.name, this.axis = a.axis, this.id = this.name + "-" + this.axis, this.waypoints = [], 
    ...
    function a(a) {
        return function() {
            var c = [], d = arguments[0];
            return a.isFunction(arguments[0]) && (d = a.extend({}, arguments[1]), d.handler = arguments[0]), 
            this.each(function() {
                var e = a.extend({}, d, {
                    element: this
                });
    ...
    "use strict";
    var b = function(b, c) {
        this.el = a(b), this.options = a.extend({}, a.fn.typed.defaults, c), this.isInput = this.el.is("input"), 
    ...
    b.prototype = {
        ...
        build: function() {
            var b = this;
            if (this.showCursor === !0 && (this.cursor = a('<span class="typed-cursor">' + this.cursorChar + "</span>"), 
            ...
            if (this.stop !== !0) {
                ...
                d.timeout = setTimeout(function() {
                    ...
                    if ("html" === d.contentType) {
                        ...
                        if ("<" === g || "&" === g) {
                            var h = "", i = "";
                            for (i = "<" === g ? ">" : ";"; a.substr(b).charAt(0) !== i; ) h += a.substr(b).charAt(0), 
                            b++;
                            b++, h += i;
                        }
                    }
                    d.timeout = setTimeout(function() {
                        if (b === a.length) {
                            if (d.options.onStringTyped(d.arrayPos), d.arrayPos === d.strings.length - 1 && (d.options.callback(), 
                            d.curLoop++, d.loop === !1 || d.curLoop === d.loopCount)) return;
                            d.timeout = setTimeout(function() {
                                d.backspace(a, b);
                            }, d.backDelay);
                        } else {
                            ...
                            d.attr ? d.el.attr(d.attr, c) : d.isInput ? d.el.val(c) : "html" === d.contentType ? d.el.html(c) : d.el.text(c), 
                            b++, d.typewrite(a, b);
                        }
                    }, c);
                }, c);
            ...
            if (this.stop !== !0) {
                ...
                d.timeout = setTimeout(function() {
                    if ("html" === d.contentType && ">" === a.substr(b).charAt(0)) {
                        for (var c = ""; "<" !== a.substr(b).charAt(0); ) c -= a.substr(b).charAt(0), b--;
                        b--, c += "<";
                    }
                    var e = a.substr(0, b);
                    d.attr ? d.el.attr(d.attr, e) : d.isInput ? d.el.val(e) : "html" === d.contentType ? d.el.html(e) : d.el.text(e), 
                    b > d.stopNum ? (b--, d.backspace(a, b)) : b <= d.stopNum && (d.arrayPos++, d.arrayPos === d.strings.length ? (d.arrayPos = 0, 
                    d.shuffle && (d.sequence = d.shuffleArray(d.sequence)), d.init()) : d.typewrite(d.strings[d.sequence[d.arrayPos]], b));
                }, c);
            }
        },
        shuffleArray: function(a) {
            var b, c, d = a.length;
            if (d) for (;--d; ) c = Math.floor(Math.random() * (d + 1)), b = a[c], a[c] = a[d], 
            a[d] = b;
            return a;
        },
        reset: function() {
            ...
            this.el.after('<span id="' + b + '"/>'), this.el.remove(), "undefined" != typeof this.cursor && this.cursor.remove(), 
